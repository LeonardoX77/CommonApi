...
namespace Common.Tests.Services
{
    public class PhotographerServiceTests : IClassFixture<TestFixture>
    {
            ...
            Photographer entity)
        {
            ...
            IQueryable<Photographer> filteredEntitiesMockl = default;
            repo.Setup(r => r.Get(It.IsAny<IDynamicExpression<Photographer>>()))
                .Returns((IDynamicExpression<Photographer> exp) =>
                {
                    var entities = new List<Photographer>() { entity };
