...
namespace Common.Tests.Repositories
{
    public class ClientRepositoryTests : IClassFixture<TestFixture>
    {
        ...
        [Theory, AutoMoq]
        public void Get_ByDynamicFilter_Equal_Ok([Frozen] Mock<AppDbContext> ctxMock)
        {
            Mock<DbSet<Client>> setMock = _fixture.GetMockEntities<Client>(10)
                .AsQueryable().BuildMockDbSet();
            ...
            IQueryable<Client> result = sut.Get(new DynamicExpression<Client, ClientQueryFilter>(x => x.Id == 10));
